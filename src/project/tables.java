...
public class tables {
    public static void main(String[]args){
        ...
        try{
            ...
            st.executeUpdate("create table users(name varchar(200),email varchar(200),password varchar(50),securityQuestion varchar(200), answer varchar(200),addres varchar(200),status varchar(20))");
            ...
            JOptionPane.showMessageDialog(null,"se creo la tabla stisfactoriamente");
        }catch(Exception e){
